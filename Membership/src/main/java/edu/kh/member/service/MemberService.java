...
public interface MemberService {
	...
	/**
	 * 전달 받은 이름, 휴대폰 번호를 이용해서 회원 추가 단, 목록에 있는 회원 중 같은 번호의 회원이 존재하면 false 반환 / 없으면 가입
	 * 후 true 반환
	 * 
	 * @param name
	 * @param phone
	...
	/**
	 * searchName과 같은 이름을 지닌 회원 조회 - 동명이인이 존재하면 모두 조회
	 * 
	 * @param searchName
	 ...
	 * @param target
	 * @param acc
	 * @return 4: 성공, 0/1/2 : 일반/골드/다이아몬드 등급 변경됨
	 * @throws IOException
	 */
